/*
 ...
 Source Host           : 192.168.28.130:3306
 Source Schema         : teams
...
CREATE TABLE `sys_config`  (
  ...
  UNIQUE INDEX `unq_param_key`(`param_key` ASC) USING BTREE,
...
CREATE TABLE `tb_checkin`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unq_user_id`(`user_id` ASC, `date` ASC) USING BTREE,
  INDEX `idx_date`(`date` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 85 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '签到表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_checkin
-- ----------------------------
INSERT INTO `tb_checkin` VALUES (36, 6, '广东省广州市黄埔区峻祥路', '中国', '广东省', '广州市', '黄埔区', 1, 1, '2022-07-12', '2022-07-12 17:13:24');
INSERT INTO `tb_checkin` VALUES (41, 6, '广东省广州市黄埔区峻祥路', '中国', '广东省', '广州市', '黄埔区', 2, 1, '2022-07-14', '2022-07-14 08:35:10');
INSERT INTO `tb_checkin` VALUES (82, 25, '广东省广州市天河区天府路1号', '中国', '广东省', '广州市', '天河区', 2, 1, '2023-07-09', '2023-07-09 16:28:59');
...
CREATE TABLE `tb_dept`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unq_dept_name`(`dept_name` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_dept
-- ----------------------------
INSERT INTO `tb_dept` VALUES (6, '保安部');
...
CREATE TABLE `tb_holidays`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unq_date`(`date` ASC) USING BTREE
...
CREATE TABLE `tb_meeting`  (
  ...
  `status` smallint NOT NULL COMMENT '状态（1待审批,2审批不通过,3未开始,4进行中,5已结束）',
  `create_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `room_id` bigint NULL DEFAULT NULL COMMENT '会议房间ID',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_creator_id`(`creator_id` ASC) USING BTREE,
  INDEX `idx_date`(`date` ASC) USING BTREE,
  INDEX `idx_type`(`type` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 701 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会议表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tb_module`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unq_module_id`(`module_code` ASC) USING BTREE
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (25, 'o2Dv05R0YxOqDcW6xaiMhERxhwag', '微信用户', 'https://thirdwx.qlogo.cn/mmopen/vi_32/POgEwh4mIHO4nibH0KlMECNjjGxQUq24ZEaGT4poC6icRiccVGKSyXwibcPq4BWmiaIGuG1icwxaQX6grC9VemZoJ8rg/132', NULL, NULL, NULL, NULL, NULL, '[0]', 1, NULL, 1, '2023-07-07 15:30:45');
